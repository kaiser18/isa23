package com.ftn.isa23.config;

import com.ftn.isa23.security.auth.RestAuthenticationEntryPoint;
import com.ftn.isa23.security.auth.TokenAuthenticationFilter;
import com.ftn.isa23.security.auth.TokenUtils;
import com.ftn.isa23.users.service.impl.CustomUserDetailsService;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/auth/**").permitAll()		// /auth/**
                ...
                .antMatchers("/company/findAll").permitAll()
                .antMatchers("/company/getById").permitAll()
